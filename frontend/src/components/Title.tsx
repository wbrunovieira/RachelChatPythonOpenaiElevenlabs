...
function Title({ setMessages }: Props) {
    ...
    return (
        <div className="flex justify-between items-center w-full p-4 bg-customPurple1 text-white font-bold shadow">
            ...
            <div className="flex  justify-center align-center gap-2 text-customYellow font-normal">
                <button
                    onClick={resetConversation}
                    className={
                        "flex gap-2 transition-all duration-300 text-customYellow hover:text-white " +
